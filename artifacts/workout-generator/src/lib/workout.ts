...
const EXERCISES: Exercise[] = [
  ...
  { name: "Приседание с подушкой между коленями", muscle: "core", equipment: "none", goals: ALL, femaleOnly: true },
...
function cueFor(name: string): string {
  ...
  const rules: Array<[RegExp, string]> = [
    ...
    [/присед.*подушк.*между колен/, "Зажмите подушку между коленями, опускайтесь в неглубокий присед, на подъёме сжимайте подушку и тазовое дно."],
